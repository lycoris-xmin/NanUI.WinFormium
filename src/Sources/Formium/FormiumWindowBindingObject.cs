...
using WinFormium.Sources.JavaScript.WindowBinding;

namespace WinFormium.Sources.Formium;
internal class FormiumWindowBindingObject : JavaScriptWindowBindingObject
{
    ...
    private void SendHostWindowMessageRequestAsync(WinFormium.Formium owner, JavaScriptArray arguments, JavaScriptPromise promise)
    {
    ...
    private JavaScriptValue? SendHostWindowMessageRequest(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue? PostHostWindowMessage(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue GetCurrentCulture(WinFormium.Formium owner, JavaScriptArray args)
    {
    ...
    private JavaScriptValue? Minimize(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? Maximize(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? Restore(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? FullScreen(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? Close(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? MoveTo(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue? MoveBy(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue? SizeTo(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue? SizeBy(WinFormium.Formium owner, JavaScriptArray arguments)
    {
    ...
    private JavaScriptValue? Active(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue? Center(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue GetWindowState(WinFormium.Formium owner, JavaScriptArray _)
    {

        return new JavaScriptValue($"{owner?.WindowState.ToString().ToLower() ?? "normal"}");
    }

    private JavaScriptValue GetWindowLocation(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue GetWindowSize(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue GetWindowRectangle(WinFormium.Formium owner, JavaScriptArray _)
    {
    ...
    private JavaScriptValue IsFramelessWindow(WinFormium.Formium owner, JavaScriptArray _)
    {

        return !owner.CurrentFormStyle.HasSystemTitleBar;
    }

    private JavaScriptValue IsEmbeddedInControl(WinFormium.Formium owner, JavaScriptArray _)
    {
