...
public abstract class AudioHandler : IAudioHandler
{
    ...
    void IAudioHandler.OnAudioStreamPacket(CefBrowser browser, nint data, int frames, long pts)
    {
    ...
    protected virtual void OnAudioStreamPacket(CefBrowser browser, nint data, int frames, long pts)
    {
    }
