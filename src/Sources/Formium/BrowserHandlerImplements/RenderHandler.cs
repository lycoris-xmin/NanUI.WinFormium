...
public abstract class RenderHandler : IRenderHandler
{
    ...
    protected virtual void OnAcceleratedPaint(CefBrowser browser, CefPaintElementType type, CefRectangle[] dirtyRects, nint sharedHandle)
    {
    }
    ...
    protected virtual void OnPaint(CefBrowser browser, CefPaintElementType type, CefRectangle[] dirtyRects, nint buffer, int width, int height)
    {
    }
