...
public delegate void OnOffscreenPaintDelegate(CefPaintElementType type, nint bufferPtr, int width, int height, bool isPopupShown, CefRectangle? popupRect = null);
