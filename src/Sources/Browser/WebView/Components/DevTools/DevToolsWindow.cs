...
namespace WinFormium.Sources.Browser.WebView.Components.DevTools;
internal class DevToolsWindow : StandardWindowForm
{
    public WinFormium.Browser.WebView WebView { get; }

    public nint? BrowserWindowHandle { get; internal set; }

    public DevToolsWindow(WinFormium.Browser.WebView webview) : base(false, false)
    {
