...
using WinFormium.Sources.Formium;
using WinFormium.Sources.JavaScript.WindowBinding;
using WinFormium.Sources.Logging;
using WinFormium.Sources.Utils;

namespace WinFormium.Sources.Browser.WebView.RendererProcess;
internal class RenderProcessHandler : CefRenderProcessHandler
{
    ...
    private void RegisterWindowBindingObjects()
    {
        ...
        var windowBindingObjects = _browserApp.ApplicationContext.ServiceProvider.GetServices<JavaScriptWindowBindingObject>();
