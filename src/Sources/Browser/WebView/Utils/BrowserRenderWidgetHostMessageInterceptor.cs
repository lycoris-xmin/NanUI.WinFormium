...
namespace WinFormium.Sources.Browser.WebView.Utils;
...
internal class BrowserRenderWidgetHostMessageInterceptor : NativeWindow
{
    ...
    internal static Task<BrowserRenderWidgetHostMessageInterceptor?> Setup(BrowserRenderWidgetHostMessageInterceptor? interceptor, WinFormium.Formium formium, WindowMessageDelegate forwardAction)
    {
        return Task.Run(() =>
        {
            try
