...
using WinFormium.Sources.Browser.WebView.BrowserProcess;
using WinFormium.Sources.Browser.WebView.RendererProcess;

namespace WinFormium.Sources.Browser;
...
internal class BrowserApp : CefApp
{
    ...
    public ChromiumEnvironment Environment => ApplicationContext.ServiceProvider!.GetService<ChromiumEnvironment>()!;
